...
export declare const ALL_LIMIT_CODES: readonly ("org.members.max" | "jira.connections.max" | "sprint.snapshots.retention.days" | "ai.requests.monthly" | "reports.exports.monthly" | "teams.max" | "chat.history.retention.days")[];
